...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002366854210'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'permanent-etti-leotg12345-d60c1491.koyeb.app/')) if not ON_HEROKU or getenv('FQDN', '') else APP_NAME+'.herokuapp.com'
